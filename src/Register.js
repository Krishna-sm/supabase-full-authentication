...
const Register = () => {
  ...
  <div className="container px-5 py-10 mx-auto flex flex-wrap items-center">
    ...
    <div className="relative mb-4">
        ...
        <input onChange={onChangeHandler} type="text" id="name" name="name" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
      </div>
      <div className="relative mb-4">
      ...
      <p className="text-xs text-gray-500 mt-3">Already Have an Account ? <Link to={'/login'}>Sign In</Link></p>
    </form>
  </div>
</section>
